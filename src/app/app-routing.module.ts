...
const routes: Routes = [
  ...
  {
    path: 'q17',
    loadChildren: () => import('./q17/q17.module').then((m) => m.Q17Module),
  },
  {
    path: 'q18',
    loadChildren: () => import('./q18/q18.module').then((m) => m.Q18Module),
  },
  {
    path: 'q19',
    loadChildren: () => import('./q19/q19.module').then((m) => m.Q19Module),
  },
  {
    path: 'q20',
    loadChildren: () => import('./q20/q20.module').then((m) => m.Q20Module),
  },
